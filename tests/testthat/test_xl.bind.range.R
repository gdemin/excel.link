...
expect_identical(gsub("^(.+?)!","",xl.binding.address(a1)$address,perl=TRUE), "$A$1")
expect_identical(gsub("^(.+?)!","",xl.binding.address(cra1)$address,perl=TRUE), "$A$1")
...
expect_identical(gsub("^(.+?)!","",xl.binding.address(a1)$address,perl=TRUE), "$A$1")
expect_identical(gsub("^(.+?)!","",xl.binding.address(cra1)$address,perl=TRUE), "$A$1:$B$2")
...
expect_identical(gsub("^(.+?)!","",xl.binding.address(a1)$address,perl=TRUE), "$A$1:$F$151")
expect_identical(gsub("^(.+?)!","",xl.binding.address(cra1)$address,perl=TRUE), "$A$1:$F$151")
